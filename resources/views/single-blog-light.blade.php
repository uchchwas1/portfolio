...
<body data-spy="scroll" data-target="#navbar-collapse-toggle" data-offset="70" class="theme-light">
    ...
    <header class="header-left" id="navbar-collapse-toggle">
        <div class="scroll-bar">
            ...
            <ul class="nav nav-menu">
                <li>
                    <a class="nav-link" href="index-light.html#home" data-toggle="tooltip" title="HOME">
                        <i class="fas fa-house-damage"></i>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="index-light.html#about" data-toggle="tooltip" title="ABOUT">
                        <i class="far fa-address-card"></i>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="index-light.html#resume" data-toggle="tooltip" title="RESUME">
                        <i class="far fa-file"></i>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="index-light.html#work" data-toggle="tooltip" title="WORK">
                        <i class="fas fa-briefcase"></i>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="index-light.html#blog" data-toggle="tooltip" title="BLOG">
                        <i class="fas fa-blog"></i>
                    </a>
                </li>
                <li>
                    <a class="nav-link" href="index-light.html#contactus" data-toggle="tooltip" title="CONTACT">
                        ...
                        <div class="contact-form article-comment">
                            ...
                            <form id="contact-form" method="POST">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="send">
                                            <button class="px-btn px-btn-white"><span>Submit</span> <i class="arrow"></i></button>
                                        </div>
                                    </div>
                                </div>
                            </form>
    ...
    <a href="https://themeforest.net/item/nairo-bootstrap-4-personal-portfolio/27231134" class="fixd-btn" style="position: fixed; bottom: 20px; right: 20px; background: #bc0609; padding: 9px 34px; display: inline-block; color: #fff; font-weight: 600; border-radius: 60px;">
        <span>Buy Now</span>
    </a>
